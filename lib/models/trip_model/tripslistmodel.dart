import 'package:ortharize_mobile/models/trip_model/trip_detail_model.dart';
...
final TripDetailModel? data;
 ...
 factory TripsListModel.fromJson(Map<String, dynamic> json) => TripsListModel(
   ...
   data: json['data']['tripdetail']==null?null:TripDetailModel.fromJson(json['data']['tripdetail']),
