...
class AllTripsController extends GetxController {
  List<Map<String, dynamic>> tempAllTrips = [
    {
    ...
    {
      'tripsTitle': 'Gurgaon Trip',
      'startDate': '2 March 2021',
      'endDate': '5 March 2021',
      'data': {},
      'cars': {},
      'airways': {},
      'trainDetails': {},
    ...
    {
      'tripsTitle': 'Pune Trip',
      'startDate': '18 February 2021',
      'endDate': '21 February 2021',
      'data': {},
      'cars': {},
      'airways': {},
      'trainDetails': {},
  ...
  @override
  void onInit() {
    for (int i = 0; i < tempAllTrips.length; i++) {
      allTripsList.add(TripsListModel.fromJson(tempAllTrips[i]));
    }
    super.onInit();
  }
}
